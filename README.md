# `GAP_pkg_juliainterface_jll.jl` (v0.1300.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/885a758bcc8b19ed986abdde3c5740ca8bd29e5b/G/GAP_pkg/GAP_pkg_juliainterface/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/GAP.jl (revision: `19922966dbe38652696798a1986d0b7fc6520cd6`)
