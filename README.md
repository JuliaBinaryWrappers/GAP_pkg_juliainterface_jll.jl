# `GAP_pkg_juliainterface_jll.jl` (v0.900.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/9d312d6f09b59c0d068cbe0baaca108661eb02a2/G/GAP_pkg/GAP_pkg_juliainterface/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/GAP.jl (revision: `bc4b5c2374299564184fb79f00fedbba4a255d39`)
